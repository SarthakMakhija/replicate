fn main() -> Result<(), Box<dyn std::error::Error>> {
    tonic_build::configure()
        ...
        .type_attribute("examples.quorum.VersionedPutKeyValueRequest", "#[raft_macro::add_correlation_id]")
        .type_attribute("examples.quorum.PutKeyValueResponse", "#[raft_macro::add_correlation_id]")
