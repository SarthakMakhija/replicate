...
use crate::net::connect::service_server_callable::{ServiceClient, ServiceServerError};

pub(crate) struct HeartbeatServiceClient {}

#[async_trait]
impl ServiceClient<HeartbeatRequest, ()> for HeartbeatServiceClient {
    async fn call(&self, request: HeartbeatRequest, address: &HostAndPort) -> Result<Response<()>, ServiceServerError> {
